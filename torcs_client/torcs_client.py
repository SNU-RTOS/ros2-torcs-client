...
class TORCSClient(Node):
    ...
    def __init__(self):
        ...
        self.ctrl_sub = self.create_subscription(TORCSCtrl, "torcs_ctrl_in", self.ctrlCallback, 1000)
        self.ctrl_pub = self.create_publisher(TORCSCtrl, "torcs_ctrl_out", 1000)
        self.torcs_sensors_pub = self.create_publisher(TORCSSensors, "torcs_sensors_out", 1000)
        self.globalSpeed_pub = self.create_publisher(TwistStamped, "torcs_global_speed", 1000)
        self.globalPose_pub = self.create_publisher(PoseStamped, "torcs_global_pose", 1000)
        self.globalRPY_pub = self.create_publisher(Vector3Stamped, "torcs_global_rpy", 1000)
        self.track_pub = self.create_publisher(LaserScan, "torcs_track", 1000)
        self.opponents_pub = self.create_publisher(LaserScan, "torcs_opponents", 1000)
        self.focus_pub = self.create_publisher(LaserScan, "torcs_focus", 1000)
        self.speed_pub = self.create_publisher(TwistStamped, "torcs_speed", 1000)
        self.debug_pub = self.create_publisher(String, "udp_string", 1000)
        self.restart_pub = self.create_publisher(Bool, "notifications/restart_process", 1000)
